...
#define RTC_PRESCALER_SET	(4095)
#define RTC_FREQUENCY		(32768)
#define RTC_TICK_PER_SEC	(RTC_FREQUENCY/ (RTC_PRESCALER_SET+ 1))
//#define LED_IWANT 4

///* toggle pin */
//void toggle_pin()
//{
//	static rt_int8_t state= 1;
//	LOG_I("%d ", state);
//	rt_pin_write(LED_IWANT, state);	/* 蓝灯 */
//	state = !state;
//}
...
{
//	rt_pin_mode(LED_IWANT, PIN_MODE_OUTPUT);
//	rt_pin_write(LED_IWANT, PIN_LOW);
    ...
    config.prescaler = RTC_PRESCALER_SET;
...
#else
static rt_err_t rt_hw_rtc_register(rt_rtc_dev_t* rtc, const char *name, rt_uint32_t flag, void *data)
{
    struct tm time_new = ONCHIP_RTC_TIME_DEFAULT;
